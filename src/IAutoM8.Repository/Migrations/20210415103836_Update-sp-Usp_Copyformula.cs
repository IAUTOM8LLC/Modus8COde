...
{
    public partial class UpdatespUsp_Copyformula : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"/***** Object: StoredProcedure [dbo].[Usp_CopyFormula] Script Date: 15-04-2021 16:05:10 *****/
SET ANSI_NULLS ON
GO
...
-- Modified by Nikhil Sehgal on 2021-03-02 --> added new insert for Formulataskchecklist table
-- =============================================
...
NAME,
type)
SELECT DISTINCT ftc.Id, @CurrentDate,
OOA.id,
ftc.NAME,
ftc.type
FROM formulataskchecklist ftc
