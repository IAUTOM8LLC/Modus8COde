...
{
    public partial class AddStoreProcGetAllTasks : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var query = @"/****** Object:  StoredProcedure [dbo].[uspGetAllTasksForUsers]    Script Date: 10-08-2020 05:10:09 PM ******/
SET ANSI_NULLS ON
GO
...
END";
        ...
        {
            migrationBuilder.Sql(@"DROP PROCEDURE IF EXISTS [dbo].[uspGetAllTasksForUsers];");
        }
    }
}
