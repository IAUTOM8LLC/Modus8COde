...
{
    public partial class Add_StoreProc_VendorDataUpdateForLost : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var query = @"CREATE PROCEDURE [dbo].[USPVENDORDATAUPDATEFORLOST]
...
END";
        ...
        {
            migrationBuilder.Sql(@"DROP PROCEDURE IF EXISTS [dbo].[USPVENDORDATAUPDATEFORLOST];");
        }
    }
}
