...
namespace IAutoM8.Repository.Migrations
{
    ...
    [Migration("20180726095508_AddCreditsTax")]
    partial class AddCreditsTax
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.CreditsTax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.User.Credits", b =>
                {
                    b.Property<Guid>("UserId");
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.User.Credits", b =>
                {
                    b.HasOne("IAutoM8.Domain.Models.User.User", "User")
                        .WithOne("Credits")
                        .HasForeignKey("IAutoM8.Domain.Models.User.Credits", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
