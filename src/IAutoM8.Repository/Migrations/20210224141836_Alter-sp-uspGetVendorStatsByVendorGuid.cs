...
{
    public partial class AlterspuspGetVendorStatsByVendorGuid : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"/****** Object:  StoredProcedure [dbo].[uspGetVendorStatsByVendorGuid]    Script Date: 24-02-2021 14:07:22 ******/
DROP PROCEDURE IF EXISTS [dbo].[uspGetVendorStatsByVendorGuid]
GO
/****** Object:  StoredProcedure [dbo].[uspGetVendorStatsByVendorGuid]    Script Date: 24-02-2021 14:07:22 ******/
SET ANSI_NULLS ON
GO
