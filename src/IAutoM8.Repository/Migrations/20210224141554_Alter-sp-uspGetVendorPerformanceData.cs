...
{
    public partial class AlterspuspGetVendorPerformanceData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"/****** Object:  StoredProcedure [dbo].[uspGetVendorPerformanceData]    Script Date: 24-02-2021 14:07:22 ******/
DROP PROCEDURE IF EXISTS [dbo].[uspGetVendorPerformanceData]
GO
/****** Object:  StoredProcedure [dbo].[uspGetVendorPerformanceData]    Script Date: 24-02-2021 14:07:22 ******/
SET ANSI_NULLS ON
GO
