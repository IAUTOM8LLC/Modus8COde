...
namespace IAutoM8.Repository.Migrations
{
    ...
    [Migration("20170918153416_AddTaskConditionToTaskHistory")]
    partial class AddTaskConditionToTaskHistory
    {
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.Project.Task.TaskHistory", b =>
                {
                    ...
                    b.HasIndex("ProjectTaskConditionOptionId")
                        .IsUnique()
                        .HasFilter("[ProjectTaskConditionOptionId] IS NOT NULL");
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.Project.Task.TaskHistory", b =>
                {
                    b.HasOne("IAutoM8.Domain.Models.Project.Task.ProjectTaskConditionOption", "ProjectTaskConditionOption")
                        .WithOne("TaskHistory")
                        .HasForeignKey("IAutoM8.Domain.Models.Project.Task.TaskHistory", "ProjectTaskConditionOptionId")
                        .OnDelete(DeleteBehavior.SetNull);
