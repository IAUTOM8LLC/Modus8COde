...
{
    public partial class Add_StoreProc_VendorProjects : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"CREATE PROCEDURE [dbo].[uspGetVendorTasksByVendorGuid]     
...
END";
        ...
        {
            migrationBuilder.Sql(@"DROP PROCEDURE IF EXISTS [dbo].[uspGetVendorTasksByVendorGuid];");
        }
    }
}
