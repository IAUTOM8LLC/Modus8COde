...
{
    public partial class CreatespuspGetCompanyUserDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"/****** Object:  StoredProcedure [dbo].[uspGetCompanyUserDetails]    Script Date: 24-02-2021 14:07:22 ******/
DROP PROCEDURE IF EXISTS [dbo].[uspGetCompanyUserDetails]
GO
/****** Object:  StoredProcedure [dbo].[uspGetCompanyUserDetails]    Script Date: 24-02-2021 14:07:22 ******/
SET ANSI_NULLS ON
GO
...
/******
exec [dbo].[uspGetCompanyUserDetails] 'D6738F05-0907-4F6D-7941-08D60A39DAA9',2
*/

CREATE PROCEDURE [dbo].[uspGetCompanyUserDetails]
...
anu_companyWorker.EmailConfirmed as isEmailConfirmed
