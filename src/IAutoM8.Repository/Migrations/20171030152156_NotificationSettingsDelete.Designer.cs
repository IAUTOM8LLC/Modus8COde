...
namespace IAutoM8.Repository.Migrations
{
    ...
    [Migration("20171030152156_NotificationSettingsDelete")]
    partial class NotificationSettingsDelete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.Project.Task.TreeDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TreeDetail");
                });

            modelBuilder.Entity("IAutoM8.Domain.Models.Project.Task.TreeLeaf", b =>
                {
                    b.Property<int>("TaskId");

                    b.Property<int>("TreeDetailId");

                    b.HasKey("TaskId", "TreeDetailId");
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.Team.Team", b =>
                {
                    ...
                    b.Property<bool>("IsSingelPersonTeam");
            ...
            modelBuilder.Entity("IAutoM8.Domain.Models.Project.Task.ProjectTask", b =>
                {
                    ...
                    b.HasOne("IAutoM8.Domain.Models.Project.Task.TreeDetail", "TreeDetail")
                        .WithMany("Task")
                        .HasForeignKey("TreeDetailId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
