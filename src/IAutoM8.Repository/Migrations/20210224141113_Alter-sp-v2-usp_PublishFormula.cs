...
{
    public partial class Alterspv2usp_PublishFormula : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"/****** Object:  StoredProcedure [dbo].[usp_PublishFormula]    Script Date: 24-02-2021 14:07:22 ******/
DROP PROCEDURE IF EXISTS [dbo].[usp_PublishFormula]
GO
/****** Object:  StoredProcedure [dbo].[usp_PublishFormula]    Script Date: 24-02-2021 14:07:22 ******/
SET ANSI_NULLS ON
GO
...
INSERT INTO FormulaTaskChecklist(DateCreated,FormulaTaskId,bussinessentityid,Name,Type)  --newly added col bussinesentityid WRT  sprint10b bugs     
SELECT DISTINCT @CurrentDate,FTClient.ID,
FTCAdmin.id,
