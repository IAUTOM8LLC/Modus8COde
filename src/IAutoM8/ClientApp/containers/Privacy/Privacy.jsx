    ...
    renderPolicy() {
        return (
            <div>
                ...
                <p>IAUTOM8 LLC (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates the
                    https://gomodus8.com website (the &quot;Service&quot;).</p>
                ...
                <p>This page informs you of our policies regarding the collection, use, and disclosure of
                    ...
                    data. This Privacy Policy  for IAUTOM8 LLC is powered
                    by <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">
                ...
                <p>We use your data to provide and improve the Service. By using the Service, you agree to
                    ...
                    as in our Terms and Conditions, accessible from https://gomodus8.com</p>
                ...
                <ul>
                    <li>Email address</li><li>First name and last name</li><li>Phone number</li><li>Address,
                        State, Province, ZIP/Postal code, City</li><li>Cookies and Usage Data</li>
                </ul>
                ...
                <p>IAUTOM8 LLC uses the collected data for various purposes:</p>
                <ul>
                    ...
                    <li>To provide analysis or valuable information so that
                        we can improve the Service</li>
                ...
                <p>IAUTOM8 LLC will take all steps reasonably necessary to ensure that your data is treated
                ...
                <p>IAUTOM8 LLC may disclose your Personal Data in the good faith belief that
                    such action is necessary to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of IAUTOM8 LLC</li>
                ...
                <p>We will let you know via email and/or a prominent notice on our Service, prior to the
                    change becoming effective and update the &quot;effective date&quot;
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="http://support.i-autom8.com">
                        http://support.i-autom8.com</a></li>
                </ul>
            </div>
        )
    }
    ...
    render() {
        return (
            <div className="login-form">
                ...
                >
                    <Grid.Column className="login-form__body privacy">
                        <Image
                            centered
                            verticalAlign="middle"
